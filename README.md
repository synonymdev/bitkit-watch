...
When blockchain or market data is refreshed, your browser connects directly to third-party public APIs. These providers may receive the public Bitcoin addresses being queried, your IP address, and standard browser request metadata.
